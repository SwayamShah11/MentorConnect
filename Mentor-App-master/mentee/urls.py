...
urlpatterns = [
    ...
    path("hod/export-filtered/", hod.hod_export_filtered, name="hod_export_filtered"),
    ...
    path('admin/export-swot-excel/', hod.hod_export_swot_excel, name='hod_export_swot_excel'),
    ...
    path("delete-query/<int:query_id>/", mentor.delete_query, name="delete_query"),
    ...
    path("credits1/", mentor.credits_view, name="credits1"),
